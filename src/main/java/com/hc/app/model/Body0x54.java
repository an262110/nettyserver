 ...
 * @author liuh
 */
public final class Body0x54 extends MegUtil implements BodyI 
{
...
//	   0x03:由第三方系统开启充电的账单	
   ...
   public Body0x54(byte[] meg) {
		...
		body6_4_int = BytesToint(bytesReverseOrder(body6_4));
   }
...
public Map<String, String> bytesToMap(){
	...
	map.put("body1_7", bytesToHexString(body1_7));
	map.put("body2_7", bytesToHexString(body2_7));
	...
	map.put("body13_10",bytesToHexString(body13_10));
...
public int getBody6_4_int() {
	return body6_4_int;
}
public void setBody6_4_int(int body6_4_int) {
	this.body6_4_int = body6_4_int;
}
