package com.hc.common.utils.KL;
 ...
 *
 */
public class KLLogUtils {
	
	private  static Logger logger = Logger.getLogger("IDNKL");
		...
		if(message!=null){
	        if(message instanceof Map){
	        	...
	        	if(head1!=null&&!head1.isEmpty()){
	        	 KLLogUtils.info("=================================控制头信息=======================");
		         KLLogUtils.info(head1);
	        	}
	        	if(head2!=null&&!head2.isEmpty()){
		        	 KLLogUtils.info("=================================标准头信息====================");
			         KLLogUtils.info(head2);
		        	}
	        	if(data!=null&&!data.isEmpty()){
		        	 KLLogUtils.info("=================================数据信息=======================");
			         KLLogUtils.info(data);
		        	}
	        }else{
	        	logger.info(message);
        }
