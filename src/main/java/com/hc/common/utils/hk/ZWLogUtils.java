 ...
 *
 */
public class ZWLogUtils {
	
	private  static Logger logger = Logger.getLogger("IDNZW");
		...
		if(message!=null){
	        if(message instanceof Map){
	        	...
	        	if(head1!=null&&!head1.isEmpty()){
	        	 ZWLogUtils.info("=================================控制头信息=======================");
		         ZWLogUtils.info(head1);
	        	}
	        	if(head2!=null&&!head2.isEmpty()){
		        	 ZWLogUtils.info("=================================标准头信息====================");
			         ZWLogUtils.info(head2);
		        	}
	        	if(data!=null&&!data.isEmpty()){
		        	 ZWLogUtils.info("=================================数据信息=======================");
			         ZWLogUtils.info(data);
		        	}
	        }else{
	        	logger.info(message);
        }
