...
public class MacUtil {
	...
	public static String xOrString(String pan,String pin)
		...
		public static String MAC(String key,String vector,String data)
		{
			if(key.length() != 32)
			{
				new Exception("key's length must be 32!").printStackTrace();
				return null;
			}
...
//		System.out.println("生成的随机数为：" + createRandom(6));
	    ...
	    //String str="";
		//00AD303030303030
	    //00000000BC800006
	    //31303230
		String str="010103000000000000000000000000000000000000000000000000000040FAD8BE00000000FFFFFFFF0000000000000000000000000100000000012020160607155551";
	    str = str.replace(" ", "");	
	    str=str.substring(0,str.length()-32);
		//String mac = MAC_ASC("3751fddf23758c9ed015f75efe34e6ba","00000000000000000000000000000000",str);
	    String mac =   MAC_ASC("33333333333333333333333333333333","00000000000000000000000000000000",str);
		System.out.println("生成Mac Block为：" + mac);//84548DE1AA580EBE
		
		//
		String block = EncodeUtil.hex(mac.getBytes());
		String lk = block.substring(0, 16);
		String rk = block.substring(16);
		//String key = "3751fddf23758c9ed015f75efe34e6ba";
		String key="33333333333333333333333333333333";
		String first = TripleDES.DES_2(lk, key, 0);
		System.out.println("first:"+first);
		String xor = xOrString(first,rk);
		System.out.println("xor:"+xor);
		String out = TripleDES.DES_2(xor, key, 0);
		System.out.println("mac:"+out);//mac:BDF56840FEEAF0B9
		String out8 = out.substring(0, 8);
		String macStr = EncodeUtil.hex(out8.getBytes()); 
	 ...
	 * @return
	 */
	public static String gemMacBlock(String data) {
